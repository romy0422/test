<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ChequeAvecMessage.ascx.cs" Inherits="CPointSoftware.ECommerce.Site.Exec.reglements.cheques.ChequeAvecMessage" %>
<div class="TypeReglement">

    <div class="Header">
    <ecom:ThemablePanelControl runat="server" ID="pnlModeReg" SkinID="ModeReglementChequeAvecMessage" RenderWithNoTag="true">
    <Content>
