<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/DefaultTheme.Master" AutoEventWireup="true" CodeBehind="ModificationAdresse.aspx.cs" Inherits="CPointSoftware.ECommerce.Site.Exec.Process.ModificationAdresse" %>
    ...
    <div id="ExecContent">
        <div id="ModificationAdresse">
            <div class="blocForm">
                ...
                Cette adresse est aussi utilisée dans une ou plusieurs de vos commandes en cours de traitement. Celles-ci ne seront
                pas impactée par votre modification, qui ne sera prise en compte que pour cette commande-ci.
                ...
                <%-- 
                     ...
                     On prefera utiliser la fonction de correction de l'adresse, depuis le compte (suivi de commande)
                 --%>
                 ...
                 <table>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            ...
                            <asp:CheckBox ID="chkAppliquerCommeLivraison" runat="server" ValidationGroup="Creation" Visible="false"
                                Text="Utiliser aussi cette adresse comme adresse de livraison" />
