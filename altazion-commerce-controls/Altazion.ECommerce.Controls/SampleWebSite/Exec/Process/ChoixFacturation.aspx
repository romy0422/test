                    ...
                    <ItemTemplate>
                        <div class="Adresse">
                            <table>
                                ...
                                <tr>
                                    <td class="Choix">
                                        <asp:linkbutton runat="server" text="Modifier" CssClass="modifier" commandname="Modifier" commandargument='<%#Eval("adr_guid")%>' />
                                        <asp:linkbutton runat="server" CssClass="choisir" text="Choisir cette adresse" typeadresse='<%#TypeAdresse%>'
                    ...
                    <tr>
                        ...
                        <td>
                            <ecom:AdresseCreationLink ID="AdresseCreationLink1" runat="server" Text="Enregistrer"
                                CssClass="Creer" ValidationGroup="Creation" AddressLine1TextBox="txtAddressLine1"
                                AddressLine2TextBox="txtAddressLine2" CityTextBox="txtCity" CountryCombo="cboCountry"
                                FirstNameTextBox="txtFirstName" PhoneTextBox="txtPhoneNumber" NameTextBox="txtName"
                                SalutationCombo="cboSalutations" ZipCodeTextBox="txtZipCode" OnAdresseCreee="AdresseCreation_AdresseCreee" />
                        </td>
                        <td>
                            &nbsp;
                        </td>
