...
<div class="ajout container saisie-adresse" id="divSaisieAdresseContainer">
    <p class="info-obligatoire">* Champs obligatoires</p>
    <div class="form">


        <div class="form-group row">
            <div class="col-md-8">
                <p id="pCreateEmail" style="display: none">
                    <input type="e-mail" id="txtCreationEMail" maxlength="100" />
                    <label for="input" class="control-label">Votre e-mail</label><i class="bar"></i>
                </p>
            </div>
            <div class="col-md-4 error-messages-saisie-adresse">
        ...
        <div class="form-group row">
            <div class="col-md-8">
                <p id="pCreatePassword" style="display: none">
        ...
        <!-- - <a href="PerteMotDePasse.aspx">Mot de passe perdu ?</a> -->
                </div>
            </div>
        </div>
        <div class="form-group row">
            <div class="col-md-8">
                <p>
                    ...
                    <asp:DropDownList runat="server" ID="cboCreationPays" ClientIDMode="static">
                    </asp:DropDownList>
                    <label for="input" class="control-label">Pays*</label><i class="bar"></i>
                </p>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-md-4">
                ...
                <p>
                    ...
                    <label for="cboCreationCivilite" class="control-label">Civilité*</label><i class="bar"></i>
        ...
        <div class="form-group row">
            <div class="col-md-4  col-a-la-ligne">
                <p>
                    <input type="text" id="txtCreationNom" maxlength="100" autocomplete="on" />
                    <label for="input" class="control-label">Nom</label><i class="bar"></i>
                </p>
            </div>
            <div class="col-md-4">
                <p>
                    <input type="text" id="txtCreationPrenom" maxlength="100" autocomplete="on" placeholder="" />
                    <label for="input" class="control-label">Prénom</label><i class="bar"></i>
                </p>
            </div>
            <div class="col-md-4 error-messages-saisie-adresse">
        ...
        <div class="form-group row">
            <div class="col-md-8">
                <p>
                    ...
                    <label for="input" class="control-label">* Adresse :</label><i class="bar"></i>
                </p>
            </div>
            <div class="col-md-4 error-messages-saisie-adresse">
        ...
        <div class="form-group row">
            <div class="col-md-8">
                <p>
                    ...
                    <label for="input" class="control-label">Compl. adresse :</label><i class="bar"></i>
                </p>
            </div>
        </div>
        <div class="form-group row">
            <div class="col-md-3  col-a-la-ligne">
                <p id="pCreationCP">
                    <input type="tel" id="txtCreationCP" maxlength="5" autocomplete="on" />
                    <label for="input" class="control-label">* Code Postal :</label><i class="bar"></i>
                </p>
            </div>
            <div class="col-md-5">
                <p>
                    <input type="text" id="txtCreationVille" maxlength="100" autocomplete="on" />
                    <label for="input" class="control-label">*Ville :</label><i class="bar"></i>
                </p>
            </div>
            <div class="col-md-4 error-messages-saisie-adresse">
        ...
        <div class="form-group row">
            <div class="col-md-4  col-a-la-ligne">
                ...
                <p>
                    ...
                    <label for="input" class="control-label">*Téléphone :</label><i class="bar"></i>
                </p>
            </div>
            <div class="col-md-4">
                <p>
        ...
        <div id="pNewsletters" class="row">
            <div class="form-group col-md-12">
                <label for="input" class="control-label">*Newsletters :</label>
            </div>
            <div class="form-radio col-md-4">
                <div class="radio">
                    <label>
                        <input type="radio" name="newsletter" value="3,11" id="rdoNewsletters1"><i class="helper"></i>Je m'inscris à la newsletter</label>
            ...
            <div class="form-radio col-md-4">
                <div class="radio">
                    <label>
                        <input type="radio" name="newsletter" value="11" id="rdoNewsletters2"><i class="helper"></i>Je ne souhaite pas m'inscrire</label>
                </div>
            </div>
            <div class="col-md-4 error-messages-saisie-adresse">
                <div id="divCreationNewsletterObligatoire" class="erreur" style="display: none">
